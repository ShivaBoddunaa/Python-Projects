...
def create_product_dialog():
    ...
    if create_btn:
        url = f"http://127.0.0.1:8000/products?products_id={product_id}&products_name={product_name}&category={product_category}&price={product_price}"
        res = requests.post(url)
        if res.status_code == 200:
...
def update_product_dialog():
    ...
    if create_btn:
        #url = f"http://127.0.0.1:8000/products/{product_id}?products_name={product_name}&category={product_category}&price={product_price}"
        url = f"http://127.0.0.1:8000/products/{product_id}?products_name={product_name}&category={product_category}&price={product_price}"
